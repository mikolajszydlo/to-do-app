...
// action creators
export const createActionAddCard = payload => ({ payload: {id: shortid.generate(),  ...payload}, type: ADD_CARD });
export const createAction_moveCard = payload => ({ payload: {id: shortid.generate(),  ...payload}, type: MOVE_CARD });
